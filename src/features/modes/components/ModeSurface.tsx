// ──────────────────────────────────────────────
// Mode surface — routes conversation, roleplay, and game screens.
// ──────────────────────────────────────────────
import {
  Suspense,
  lazy,
...
const ChatConversationSurface = lazy(async () => {
  const module = await import("../../chats/components/ChatConversationSurface");
  return { default: module.ChatConversationSurface };
});

const ChatRoleplaySurface = lazy(async () => {
  const module = await import("../../roleplay/components/ChatRoleplaySurface");
  return { default: module.ChatRoleplaySurface };
});

const GameSurface = lazy(async () => {
  const module = await import("../../game/components/GameSurface");
