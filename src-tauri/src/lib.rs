...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            storage_commands::translate_text_command,
            ...
            storage_commands::spotify_access_token,
            storage_commands::spotify_playlists,
            storage_commands::spotify_playlist_tracks,
            ...
            storage_commands::custom_tool_execute,
            storage_commands::custom_tool_capabilities,
            storage_commands::agent_patch_by_type,
            storage_commands::agent_toggle_by_type,
            storage_commands::agent_cadence_status,
            ...
            storage_commands::storage_duplicate,
            storage_commands::connection_test,
            storage_commands::connection_test_message,
            storage_commands::connection_test_image,
            storage_commands::connection_models,
            storage_commands::connection_save_default_parameters,
            storage_commands::persona_activate,
            storage_commands::character_avatar_upload,
            storage_commands::character_restore_version,
            storage_commands::persona_avatar_upload,
            storage_commands::lorebook_image_upload,
