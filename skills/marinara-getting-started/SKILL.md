---
name: marinara-getting-started
description: "Onboard developers and coding agents into Marinara. Use when someone asks how to get started, asks for a repo tour, wants the docs run, needs to run/build the app, wants a first testing checklist, or wants a guided workflow for finding and fixing bugs in this repo."
---

# Marinara Getting Started
...
- `skills/marinara-architecture-guard/SKILL.md` before explaining module ownership or code boundaries.
- `skills/marinara-bugfix-discipline/SKILL.md` before guiding a bug fix.
- `skills/marinara-mode-separation/SKILL.md` before testing or fixing chat, roleplay, game, prompts, or generation routing.
...
7. When the user names a bug, switch to `marinara-bugfix-discipline` and fix the root cause.
